...
|   |   |
|---|---|
|Your Knowledge of the Target Is …  <br>Secondhand (heard of the target)  <br>Firsthand (met the target)  <br>Extensive (know the target well)|Save Modifier  <br>+5  <br>+0  <br>-5|

  

|   |   |
|---|---|
|You Have the Target’s …  <br>Picture or other likeness  <br>Garment or other possession  <br>Body part, lock of hair, or bit of nail|Save Modifier  <br>-2  <br>-4  <br>-10|
